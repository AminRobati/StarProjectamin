...
namespace Application.Payments
{
    ...
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(IIdentityDatabaseContext identityDatabaseContext , IDataBaseContext context)
        {
        ...
        public PaymentOfOrderDto PayForOrder(int OrderId)
        {
            ...
            if (order == null)
                throw new Exception("");
            var payment = context.Payments.SingleOrDefault(p=>p.OrderId == p.Order.Id);
