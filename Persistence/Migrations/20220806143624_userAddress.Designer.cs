...
namespace Persistence.Migrations
{
    ...
    [Migration("20220806143624_userAddress")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 820, DateTimeKind.Local).AddTicks(802));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 840, DateTimeKind.Local).AddTicks(1930));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 840, DateTimeKind.Local).AddTicks(4226));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 840, DateTimeKind.Local).AddTicks(6088));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 840, DateTimeKind.Local).AddTicks(8677));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 841, DateTimeKind.Local).AddTicks(954));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 841, DateTimeKind.Local).AddTicks(2734));
            ...
            modelBuilder.Entity("Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 6, 19, 6, 23, 841, DateTimeKind.Local).AddTicks(4444));
