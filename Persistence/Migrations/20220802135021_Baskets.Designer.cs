...
namespace Persistence.Migrations
{
    ...
    [Migration("20220802135021_Baskets")]
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 567, DateTimeKind.Local).AddTicks(7036));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 576, DateTimeKind.Local).AddTicks(9516));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 577, DateTimeKind.Local).AddTicks(1669));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 577, DateTimeKind.Local).AddTicks(3542));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 577, DateTimeKind.Local).AddTicks(6152));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 577, DateTimeKind.Local).AddTicks(7754));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 2, 18, 20, 21, 577, DateTimeKind.Local).AddTicks(9528));
